...
var app = function() {
    ...
    self.get_more = function () {
        var num_tracks = self.vue.tracks.length;        //store the number of tracks
        $.getJSON(get_tracks_url(num_tracks, num_tracks + 10)/*get 10 tracks at a time*/, function (data) {
            self.vue.has_more = data.has_more;
    ...
    self.vue = new Vue({
        ...
        data: {
            ...
            logged_in: false,
            has_more: false,        //will be used to tell if you want to display more
            form_artist: null,
            form_track: null,
            form_album: null,
            selected_id: -1  // Track selected to play.
        },
        methods: /*used to determine button action*/{
